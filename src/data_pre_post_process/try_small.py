...
from exp import get_ged_select_norm_str, get_graph_stats_text


TRUE_MODEL = 'astar'


def get_text_label_ged(dataset, r, tr, qid, gid, g, model, norm, is_query, concise):
    rtn = ''
    if is_query:
        rtn += '\n\n'
    else:
    ...
    for norm in norms:
        ...
        for i in range(len(row_graphs)):
            ...
            info_dict['each_graph_text_list'] = \
                [get_text_label_ged(dataset, r, tr, i, i, q, model, norm, True, concise)] + \
                [get_text_label_ged(dataset, r, tr, i, j,
